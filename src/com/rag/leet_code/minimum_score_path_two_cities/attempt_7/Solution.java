package com.rag.leet_code.minimum_score_path_two_cities.attempt_7;
...
public class Solution {
    public int minScore(int nodeCount, int[][] roads) {
        ...
        int v = nodeCount + 1;
        LinkedList<Integer> connectedNodes2 = new LinkedList<>();
        ...
        Queue<HashMap<Integer, Integer>> queue2 = new ArrayDeque<>();
        visted[1] = true;
        queue.add(1);
        while (!queue.isEmpty()) {
            int node = queue.poll();
            connectedNodes2.add(getDistance(roads, node));
        ...
        return Collections.min(connectedNodes2);
    }
